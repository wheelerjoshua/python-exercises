...
fruits_with_more_than_two_vowels = [fruit for fruit in fruits if len([letter for letter in fruit if letter in vowels]) >= 3]
...
number_of_characters_for_each_fruit = [len(fruit) for fruit in fruits]
print(number_of_characters_for_each_fruit)
...
numbers_with_2_numerals = [number for number in numbers if len(str(abs(number))) >= 2]
numbers_with_2_numerals
